...
import ConnectGoogleSheetDialog from './ConnectGoogleSheetDialog.vue'
...
const showNewGoogleSheetDialog = ref(false)
...
const sourceTypes = [
	...
	{
		label: 'Google Sheet',
		icon: getDatabaseLogo('Google Sheet'),
		description: 'Connect to Google Sheets data',
		onClick: () => {
		showNewSourceDialog.value = false
		showNewGoogleSheetDialog.value = true
		},
	}
]
...
<template>
	...
	<ConnectGoogleSheetDialog v-model="showNewGoogleSheetDialog" />
</template>
